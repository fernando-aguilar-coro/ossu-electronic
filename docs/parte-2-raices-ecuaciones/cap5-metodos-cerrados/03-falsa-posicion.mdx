...
Prueba el método de Falsa Posición (Regula Falsi) en tiempo real. Ingresa tu propia función, define el intervalo y observa cómo el algoritmo avanza iteración por iteración en la gráfica.

<ClosedMethodsSim defaultMethod="falsa-posicion" />
